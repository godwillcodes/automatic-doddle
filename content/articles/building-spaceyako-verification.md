...
SpaceYako is the property platform I built and run. This is the part of it I think about most: not the search, not the maps, but the question of whether a stranger can check that a listing is telling the truth.
